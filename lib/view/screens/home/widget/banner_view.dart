  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<BannerController>(builder: (bannerController) {
      return (bannerController.bannerImageList != null && bannerController.bannerImageList!.isEmpty) ? const SizedBox() : Container(
        ...
        height: GetPlatform.isDesktop ? 450 : MediaQuery.of(context).size.width * 0.52,
        ...
        child: bannerController.bannerImageList != null ? Column(
          ...
          children: [
            /*Padding(
              ...
              child:SizedBox() *//*TitleWidget(title: 'Offers'.tr, onTap: () => Get.toNamed(RouteHelper.getCategoryRoute())),*//*
            ),*/
            Expanded(
