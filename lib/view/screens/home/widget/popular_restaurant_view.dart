                        ...
                        Stack(children: [
                          ClipRRect(
                            ...
                            child: CustomImage(
                              ...
                              height: 90, width: 250, fit: BoxFit.cover,
                            ),
                          ),
                          DiscountTag(
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                              ...
                              Text(
                                '${'DeliverOn'.tr} ${restaurantList[index].deliveryTime ?? ''}',
                                style: robotoMedium.copyWith(fontSize: 14, color: Theme.of(context).disabledColor),
                                maxLines: 1, overflow: TextOverflow.ellipsis,
                              )
                            ]),
                          ),
