...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: Colors.white,// ResponsiveHelper.isDesktop(context) ? Theme.of(context).cardColor : null,
      body: SafeArea(
            ...
            slivers: [
              ...
              SliverAppBar(
                ...
                title: Center(child: Container(
                  width: Dimensions.webMaxWidth, height: 50, color: Color(0XFFffeee6),
                  child: Row(children: [
                        ...
                        children: [
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text('اهلا بكم في طلبات سويت !',
                                  style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                Padding(
                                  padding: const EdgeInsets.only(top: 8.0),
                                  child: Text('سجل الدخول او انشئ حسابا جديدا لتجربة\n تسوق اسرع ',
                                ...
                                Padding(
                                  ...
                                  child: CustomButton(
                                    ...
                                    fontSize: 12,
                                      buttonText: 'sign_in'.tr, height: 25, width:100,onPressed: () async {
                          ...
                          Spacer(),
                          Image(image: AssetImage('assets/image/delivery_location.png'),width: 160,
                          ),
                        ],
                      ),
