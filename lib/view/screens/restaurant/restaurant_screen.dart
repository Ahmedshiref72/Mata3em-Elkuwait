...
class _RestaurantScreenState extends State<RestaurantScreen> {
  ...
  void initState() {
    ...
    controller =  VideoPlayerController.network('${Get.find<SplashController>().configModel!.baseUrls!.restaurantCoverPhotoUrl}/${restaurant!.coverPhoto}')
      ..initialize().then((_) {
        controller.play();
          ...
          ? CustomScrollView(
            ...
            slivers: [
              ...
              ResponsiveHelper.isDesktop(context) ? SliverToBoxAdapter(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(
                        child: ClipRRect(
                          ...
                          child: CustomImage(
                           placeholder: Images.restaurantCover, height: 100,
                ...
                expandedHeight: 360, toolbarHeight: 100,
                pinned: true, floating: true, elevation: 0.5,
                backgroundColor: Theme.of(context).cardColor,
                leading: IconButton(
                  icon: Container(
                    height: 50, width: 50,
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: restController.restaurant!.coverPhoto!.endsWith('.mp4')? VideoPlayer(controller!) : CustomImage(
