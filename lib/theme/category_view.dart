      ...
      return (categoryController.categoryList != null && categoryController.categoryList!.isEmpty) ? const SizedBox() : Column(
        children: [
          Padding(
            ...
            child:   Row(
              children: [
                Text('shortCuts'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              ],
            ),
          ),
          Row(
                            ...
                            onTap: (){
                              ...
                              switch (index) {
                                ...
                                case 1:
                                  ...
                                  break;
                                case 2:
                                  Get.toNamed(RouteHelper.getVegRestaurantsRoute('popular'));
                                  break;
                                default:
                                  routeName = '/';
                              }
                            ...
                            child: SizedBox(
                              ...
                              child: Column(children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    texts[index],
                                    style: robotoMedium.copyWith(fontSize: 14), maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center,
                                  ),
                                ),
